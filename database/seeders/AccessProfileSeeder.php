    ...
    public function run(): void
    {
        ...
        $permissoes = [
            'admin' => [
                ...
                '/qrcodelogs', '/perfis', '/paginas-sistema', '/paginas-categorias', '/auditoria', '/estabelecimentos', '/alvaras', '/fiscalizacoes', '/vigilancia/configuracoes',
                '/pharmacy/consulta-medicamentos', '/pharmacy/medicines', '/pharmacy/daily-status', '/pharmacy/monthly-acquisitions', '/pharmacy/compliance',
            ...
            'manager' => [
                ...
                '/estabelecimentos', '/alvaras', '/fiscalizacoes', '/pharmacy/consulta-medicamentos', '/pharmacy/medicines', '/pharmacy/daily-status', '/pharmacy/monthly-acquisitions', '/pharmacy/compliance',
            ],
